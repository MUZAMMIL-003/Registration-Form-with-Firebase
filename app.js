...
let user = doc.data().Userid; /// mujhe user ki id chahiye thi taki me usey posts ke sath print karwa saku
console.log(user)
...
postsChldDiv.innerHTML = (`
    <svg class="w-7 h-7 text-gray-500 dark:text-gray-400 mb-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="#">
        <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">${user}
        </h5>
      </a>
